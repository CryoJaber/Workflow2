...
return [
    ...
    'App' => [
        ...
        'webroot' => 'webroot',
        'wwwRoot' => WWW_ROOT,
        //'baseUrl' => 'workflow.cryocenter.us',
        'fullBaseUrl' => false,
        'imageBaseUrl' => 'img/',
        'cssBaseUrl' => 'css/',
        'jsBaseUrl' => 'js/',
    ...
    */
	...
	'EmailTransport' => [
		'smtp' => [
			'host' => 'dbase.cryocenter.us', //eg: codethepixel.com
			'port' => 587,
		        'username' => 'apikey', //eg: admin[at]codethepixel.com
		        'password' => 'SG.pD8lnwZJQ21LJY5VocIBW.r-fOBQeiUFnDhryCiQgrmNDJdzlN7c1vbUdv-NJAE', //email password
		        'className' => 'Smtp',
		        'client' => null,
